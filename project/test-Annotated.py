...
from dataset import create_annotated_loader, DatasetAnnotatedPatchesTest
from utils import LoadConfig, load_model, createDir, get_weights

"""
This script is used to pass all the annotated patches through the autoencoder
...
if __name__ == '__main__':
    ...
    out_dir = config["root_dir"] + "/Annotated/"
    createDir(out_dir)
    ...
    test_loader = create_annotated_loader(transform, batch_size, shuffle=False)
